...
Monitorizar: `grep -c OK .generated/tabs/*.main.log` e re-tentar UFs com falhas (ex.: grep -i "usage exhausted\|error" .generated/tabs/_.main.log).
...
Diretório de logs: .generated/tabs/_.main.log.
...
Comando:
cd /home/ubuntu/ddd-brasil && for uf in ac al ap am ba ce df es go ma mt ms mg pa pb pr pe pi rj rn rs ro rr sc sp se to; do pnpm tsx scripts/generateTabs.mts --uf=$uf --only-empty >> .generated/tabs/$uf.main.log 2>&1; done
Monitorizar: grep -c OK .generated/tabs/_.main.log; re-tentar UFs com falhas (grep -i "usage exhausted\|error" .generated/tabs/_.main.log).
