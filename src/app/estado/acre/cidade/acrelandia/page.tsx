        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <section id="recursos" className="mb-12">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <ol className="list-decimal list-inside mb-6 space-y-2">
                <li><a href="https://www.gov.br/anatel/pt-br" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Anatel</a> - seu defensor dos direitos de telecomunicações</li>
