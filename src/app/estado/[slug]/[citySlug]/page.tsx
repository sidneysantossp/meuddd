...
import { MapPin, Phone, Map, Building, BarChart, Camera, BookOpen, HelpCircle, Users, Globe } from 'lucide-react'
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de {city.name} 
                        e em outras localidades do estado de {city.state.name}.
                      </p>
                    </div>

                    {dddCodes.length > 1 && (
                      <div>
                        <h3 className="text-lg font-semibold mb-2">Todos os Códigos DDD</h3>
              ...
              <TabsContent value="servicos" className="space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-3">Serviços Públicos</h3>
                      <div className="space-y-2 text-sm text-gray-600">
                        <p><strong>Prefeitura:</strong> Contato através do site oficial ou telefone</p>
                        <p><strong>Postos de Saúde:</strong> Distribuídos pela cidade</p>
                        <p><strong>Escolas:</strong> Rede municipal e estadual</p>
                        <p><strong>Coleta de Lixo:</strong> Dias e horários definidos pela prefeitura</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
