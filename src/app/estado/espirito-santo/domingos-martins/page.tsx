...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Domingos Martins ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Domingos Martins ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Domingos Martins',
      'código DDD Domingos Martins ES',
      'telefone Domingos Martins Espírito Santo',
      'como ligar para Domingos Martins',
      'operadoras Domingos Martins ES',
      'DDD Espírito Santo',
      'Domingos Martins código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Domingos Martins',
      'telefone Domingos Martins ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Domingos Martins ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Domingos Martins, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Domingos Martins ES`,
      description: `Guia completo do código telefônico de Domingos Martins, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Domingos Martins
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Domingos Martins</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Domingos Martins 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Domingos Martins</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Domingos Martins</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Domingos Martins, 
                      ...
                      <p>
                        Para fazer ligações para Domingos Martins a partir de outras cidades, 
