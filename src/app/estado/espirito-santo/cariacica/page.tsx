...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Cariacica ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Cariacica ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Cariacica',
      'código DDD Cariacica ES',
      'telefone Cariacica Espírito Santo',
      'como ligar para Cariacica',
      'operadoras Cariacica ES',
      'DDD Espírito Santo',
      'Cariacica código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Cariacica',
      'telefone Cariacica ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Cariacica ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Cariacica, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Cariacica ES`,
      description: `Guia completo do código telefônico de Cariacica, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Cariacica</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Cariacica 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Cariacica</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Cariacica</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Cariacica, 
                      ...
                      <p>
                        Para fazer ligações para Cariacica a partir de outras cidades, 
