...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Presidente Kennedy ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Presidente Kennedy ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Presidente Kennedy',
      'código DDD Presidente Kennedy ES',
      'telefone Presidente Kennedy Espírito Santo',
      'como ligar para Presidente Kennedy',
      'operadoras Presidente Kennedy ES',
      'DDD Espírito Santo',
      'Presidente Kennedy código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Presidente Kennedy',
      'telefone Presidente Kennedy ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Presidente Kennedy ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Presidente Kennedy, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Presidente Kennedy ES`,
      description: `Guia completo do código telefônico de Presidente Kennedy, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Presidente Kennedy
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Presidente Kennedy</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Presidente Kennedy 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Presidente Kennedy</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Presidente Kennedy</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Presidente Kennedy, 
                      ...
                      <p>
                        Para fazer ligações para Presidente Kennedy a partir de outras cidades, 
