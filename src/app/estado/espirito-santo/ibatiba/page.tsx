...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Ibatiba ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Ibatiba ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Ibatiba',
      'código DDD Ibatiba ES',
      'telefone Ibatiba Espírito Santo',
      'como ligar para Ibatiba',
      'operadoras Ibatiba ES',
      'DDD Espírito Santo',
      'Ibatiba código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Ibatiba',
      'telefone Ibatiba ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Ibatiba ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Ibatiba, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Ibatiba ES`,
      description: `Guia completo do código telefônico de Ibatiba, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Ibatiba</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Ibatiba 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Ibatiba</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Ibatiba</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Ibatiba, 
                      ...
                      <p>
                        Para fazer ligações para Ibatiba a partir de outras cidades, 
