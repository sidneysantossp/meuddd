...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Afonso Cláudio ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Afonso Cláudio ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Afonso Cláudio',
      'código DDD Afonso Cláudio ES',
      'telefone Afonso Cláudio Espírito Santo',
      'como ligar para Afonso Cláudio',
      'operadoras Afonso Cláudio ES',
      'DDD Espírito Santo',
      'Afonso Cláudio código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Afonso Cláudio',
      'telefone Afonso Cláudio ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Afonso Cláudio ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Afonso Cláudio, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Afonso Cláudio ES`,
      description: `Guia completo do código telefônico de Afonso Cláudio, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Afonso Cláudio
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Afonso Cláudio</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Afonso Cláudio 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Afonso Cláudio</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Afonso Cláudio</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Afonso Cláudio, 
                      ...
                      <p>
                        Para fazer ligações para Afonso Cláudio a partir de outras cidades, 
