...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Vila Pavão ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Vila Pavão ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Vila Pavão',
      'código DDD Vila Pavão ES',
      'telefone Vila Pavão Espírito Santo',
      'como ligar para Vila Pavão',
      'operadoras Vila Pavão ES',
      'DDD Espírito Santo',
      'Vila Pavão código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Vila Pavão',
      'telefone Vila Pavão ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Vila Pavão ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Vila Pavão, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Vila Pavão ES`,
      description: `Guia completo do código telefônico de Vila Pavão, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Vila Pavão</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Vila Pavão 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Vila Pavão</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Vila Pavão</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Vila Pavão, 
                      ...
                      <p>
                        Para fazer ligações para Vila Pavão a partir de outras cidades, 
