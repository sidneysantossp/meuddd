...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Laranja da Terra ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Laranja da Terra ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Laranja da Terra',
      'código DDD Laranja da Terra ES',
      'telefone Laranja da Terra Espírito Santo',
      'como ligar para Laranja da Terra',
      'operadoras Laranja da Terra ES',
      'DDD Espírito Santo',
      'Laranja da Terra código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Laranja da Terra',
      'telefone Laranja da Terra ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Laranja da Terra ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Laranja da Terra, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Laranja da Terra ES`,
      description: `Guia completo do código telefônico de Laranja da Terra, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Laranja da Terra
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Laranja da Terra</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Laranja da Terra 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Laranja da Terra</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Laranja da Terra</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Laranja da Terra, 
                      ...
                      <p>
                        Para fazer ligações para Laranja da Terra a partir de outras cidades, 
