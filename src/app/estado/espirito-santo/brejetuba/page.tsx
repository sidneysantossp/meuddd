...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Brejetuba ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Brejetuba ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Brejetuba',
      'código DDD Brejetuba ES',
      'telefone Brejetuba Espírito Santo',
      'como ligar para Brejetuba',
      'operadoras Brejetuba ES',
      'DDD Espírito Santo',
      'Brejetuba código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Brejetuba',
      'telefone Brejetuba ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Brejetuba ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Brejetuba, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Brejetuba ES`,
      description: `Guia completo do código telefônico de Brejetuba, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Brejetuba</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Brejetuba 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Brejetuba</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Brejetuba</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Brejetuba, 
                      ...
                      <p>
                        Para fazer ligações para Brejetuba a partir de outras cidades, 
