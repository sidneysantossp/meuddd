...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Bom Jesus do Norte ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Bom Jesus do Norte ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Bom Jesus do Norte',
      'código DDD Bom Jesus do Norte ES',
      'telefone Bom Jesus do Norte Espírito Santo',
      'como ligar para Bom Jesus do Norte',
      'operadoras Bom Jesus do Norte ES',
      'DDD Espírito Santo',
      'Bom Jesus do Norte código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Bom Jesus do Norte',
      'telefone Bom Jesus do Norte ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Bom Jesus do Norte ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Bom Jesus do Norte, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Bom Jesus do Norte ES`,
      description: `Guia completo do código telefônico de Bom Jesus do Norte, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Bom Jesus do Norte
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Bom Jesus do Norte</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Bom Jesus do Norte 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Bom Jesus do Norte</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Bom Jesus do Norte</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Bom Jesus do Norte, 
                      ...
                      <p>
                        Para fazer ligações para Bom Jesus do Norte a partir de outras cidades, 
