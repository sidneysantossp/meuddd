...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Marataízes ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Marataízes ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Marataízes',
      'código DDD Marataízes ES',
      'telefone Marataízes Espírito Santo',
      'como ligar para Marataízes',
      'operadoras Marataízes ES',
      'DDD Espírito Santo',
      'Marataízes código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Marataízes',
      'telefone Marataízes ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Marataízes ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Marataízes, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Marataízes ES`,
      description: `Guia completo do código telefônico de Marataízes, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Marataízes</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Marataízes 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Marataízes</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Marataízes</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Marataízes, 
                      ...
                      <p>
                        Para fazer ligações para Marataízes a partir de outras cidades, 
