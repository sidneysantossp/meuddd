...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Itarana ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Itarana ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Itarana',
      'código DDD Itarana ES',
      'telefone Itarana Espírito Santo',
      'como ligar para Itarana',
      'operadoras Itarana ES',
      'DDD Espírito Santo',
      'Itarana código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Itarana',
      'telefone Itarana ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Itarana ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Itarana, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Itarana ES`,
      description: `Guia completo do código telefônico de Itarana, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Itarana</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Itarana 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Itarana</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Itarana</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Itarana, 
                      ...
                      <p>
                        Para fazer ligações para Itarana a partir de outras cidades, 
