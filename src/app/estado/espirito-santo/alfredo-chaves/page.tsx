...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Alfredo Chaves ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Alfredo Chaves ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Alfredo Chaves',
      'código DDD Alfredo Chaves ES',
      'telefone Alfredo Chaves Espírito Santo',
      'como ligar para Alfredo Chaves',
      'operadoras Alfredo Chaves ES',
      'DDD Espírito Santo',
      'Alfredo Chaves código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Alfredo Chaves',
      'telefone Alfredo Chaves ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Alfredo Chaves ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Alfredo Chaves, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Alfredo Chaves ES`,
      description: `Guia completo do código telefônico de Alfredo Chaves, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Alfredo Chaves
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Alfredo Chaves</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Alfredo Chaves 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Alfredo Chaves</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Alfredo Chaves</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Alfredo Chaves, 
                      ...
                      <p>
                        Para fazer ligações para Alfredo Chaves a partir de outras cidades, 
