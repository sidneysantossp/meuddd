...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Irupi ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Irupi ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Irupi',
      'código DDD Irupi ES',
      'telefone Irupi Espírito Santo',
      'como ligar para Irupi',
      'operadoras Irupi ES',
      'DDD Espírito Santo',
      'Irupi código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Irupi',
      'telefone Irupi ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Irupi ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Irupi, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Irupi ES`,
      description: `Guia completo do código telefônico de Irupi, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Irupi</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Irupi 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Irupi</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Irupi</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Irupi, 
                      ...
                      <p>
                        Para fazer ligações para Irupi a partir de outras cidades, 
