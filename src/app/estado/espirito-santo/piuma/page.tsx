...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Piúma ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Piúma ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Piúma',
      'código DDD Piúma ES',
      'telefone Piúma Espírito Santo',
      'como ligar para Piúma',
      'operadoras Piúma ES',
      'DDD Espírito Santo',
      'Piúma código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Piúma',
      'telefone Piúma ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Piúma ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Piúma, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Piúma ES`,
      description: `Guia completo do código telefônico de Piúma, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Piúma</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Piúma 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Piúma</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Piúma</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Piúma, 
                      ...
                      <p>
                        Para fazer ligações para Piúma a partir de outras cidades, 
