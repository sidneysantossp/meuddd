...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} São Domingos do Norte ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} São Domingos do Norte ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} São Domingos do Norte',
      'código DDD São Domingos do Norte ES',
      'telefone São Domingos do Norte Espírito Santo',
      'como ligar para São Domingos do Norte',
      'operadoras São Domingos do Norte ES',
      'DDD Espírito Santo',
      'São Domingos do Norte código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para São Domingos do Norte',
      'telefone São Domingos do Norte ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} São Domingos do Norte ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de São Domingos do Norte, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} São Domingos do Norte ES`,
      description: `Guia completo do código telefônico de São Domingos do Norte, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em São Domingos do Norte
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre São Domingos do Norte</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de São Domingos do Norte 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre São Domingos do Norte</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em São Domingos do Norte</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em São Domingos do Norte, 
                      ...
                      <p>
                        Para fazer ligações para São Domingos do Norte a partir de outras cidades, 
