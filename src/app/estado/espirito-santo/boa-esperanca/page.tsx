...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Boa Esperança ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Boa Esperança ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Boa Esperança',
      'código DDD Boa Esperança ES',
      'telefone Boa Esperança Espírito Santo',
      'como ligar para Boa Esperança',
      'operadoras Boa Esperança ES',
      'DDD Espírito Santo',
      'Boa Esperança código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Boa Esperança',
      'telefone Boa Esperança ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Boa Esperança ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Boa Esperança, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Boa Esperança ES`,
      description: `Guia completo do código telefônico de Boa Esperança, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Boa Esperança
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Boa Esperança</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Boa Esperança 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Boa Esperança</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Boa Esperança</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Boa Esperança, 
                      ...
                      <p>
                        Para fazer ligações para Boa Esperança a partir de outras cidades, 
