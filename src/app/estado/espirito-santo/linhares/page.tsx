...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Linhares ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Linhares ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Linhares',
      'código DDD Linhares ES',
      'telefone Linhares Espírito Santo',
      'como ligar para Linhares',
      'operadoras Linhares ES',
      'DDD Espírito Santo',
      'Linhares código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Linhares',
      'telefone Linhares ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Linhares ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Linhares, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Linhares ES`,
      description: `Guia completo do código telefônico de Linhares, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Linhares</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Linhares 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Linhares</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Linhares</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Linhares, 
                      ...
                      <p>
                        Para fazer ligações para Linhares a partir de outras cidades, 
