...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Aracruz ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Aracruz ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Aracruz',
      'código DDD Aracruz ES',
      'telefone Aracruz Espírito Santo',
      'como ligar para Aracruz',
      'operadoras Aracruz ES',
      'DDD Espírito Santo',
      'Aracruz código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Aracruz',
      'telefone Aracruz ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Aracruz ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Aracruz, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Aracruz ES`,
      description: `Guia completo do código telefônico de Aracruz, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Aracruz</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Aracruz 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Aracruz</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Aracruz</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Aracruz, 
                      ...
                      <p>
                        Para fazer ligações para Aracruz a partir de outras cidades, 
