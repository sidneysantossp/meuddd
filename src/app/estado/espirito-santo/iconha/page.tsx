...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Iconha ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Iconha ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Iconha',
      'código DDD Iconha ES',
      'telefone Iconha Espírito Santo',
      'como ligar para Iconha',
      'operadoras Iconha ES',
      'DDD Espírito Santo',
      'Iconha código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Iconha',
      'telefone Iconha ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Iconha ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Iconha, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Iconha ES`,
      description: `Guia completo do código telefônico de Iconha, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Iconha</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Iconha 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Iconha</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Iconha</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Iconha, 
                      ...
                      <p>
                        Para fazer ligações para Iconha a partir de outras cidades, 
