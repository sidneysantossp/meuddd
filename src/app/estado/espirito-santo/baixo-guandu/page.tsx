...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Baixo Guandu ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Baixo Guandu ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Baixo Guandu',
      'código DDD Baixo Guandu ES',
      'telefone Baixo Guandu Espírito Santo',
      'como ligar para Baixo Guandu',
      'operadoras Baixo Guandu ES',
      'DDD Espírito Santo',
      'Baixo Guandu código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Baixo Guandu',
      'telefone Baixo Guandu ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Baixo Guandu ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Baixo Guandu, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Baixo Guandu ES`,
      description: `Guia completo do código telefônico de Baixo Guandu, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Baixo Guandu
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Baixo Guandu</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Baixo Guandu 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Baixo Guandu</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Baixo Guandu</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Baixo Guandu, 
                      ...
                      <p>
                        Para fazer ligações para Baixo Guandu a partir de outras cidades, 
