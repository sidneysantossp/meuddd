...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Guarapari ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Guarapari ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Guarapari',
      'código DDD Guarapari ES',
      'telefone Guarapari Espírito Santo',
      'como ligar para Guarapari',
      'operadoras Guarapari ES',
      'DDD Espírito Santo',
      'Guarapari código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Guarapari',
      'telefone Guarapari ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Guarapari ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Guarapari, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Guarapari ES`,
      description: `Guia completo do código telefônico de Guarapari, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Guarapari</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Guarapari 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Guarapari</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Guarapari</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Guarapari, 
                      ...
                      <p>
                        Para fazer ligações para Guarapari a partir de outras cidades, 
