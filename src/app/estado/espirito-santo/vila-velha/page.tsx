...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Vila Velha ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Vila Velha ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Vila Velha',
      'código DDD Vila Velha ES',
      'telefone Vila Velha Espírito Santo',
      'como ligar para Vila Velha',
      'operadoras Vila Velha ES',
      'DDD Espírito Santo',
      'Vila Velha código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Vila Velha',
      'telefone Vila Velha ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Vila Velha ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Vila Velha, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Vila Velha ES`,
      description: `Guia completo do código telefônico de Vila Velha, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Vila Velha</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Vila Velha 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Vila Velha</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Vila Velha</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Vila Velha, 
                      ...
                      <p>
                        Para fazer ligações para Vila Velha a partir de outras cidades, 
