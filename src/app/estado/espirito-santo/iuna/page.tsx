...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Iúna ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Iúna ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Iúna',
      'código DDD Iúna ES',
      'telefone Iúna Espírito Santo',
      'como ligar para Iúna',
      'operadoras Iúna ES',
      'DDD Espírito Santo',
      'Iúna código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Iúna',
      'telefone Iúna ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Iúna ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Iúna, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Iúna ES`,
      description: `Guia completo do código telefônico de Iúna, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Iúna</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Iúna 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Iúna</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Iúna</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Iúna, 
                      ...
                      <p>
                        Para fazer ligações para Iúna a partir de outras cidades, 
