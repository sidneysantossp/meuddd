...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Marilândia ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Marilândia ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Marilândia',
      'código DDD Marilândia ES',
      'telefone Marilândia Espírito Santo',
      'como ligar para Marilândia',
      'operadoras Marilândia ES',
      'DDD Espírito Santo',
      'Marilândia código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Marilândia',
      'telefone Marilândia ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Marilândia ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Marilândia, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Marilândia ES`,
      description: `Guia completo do código telefônico de Marilândia, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Marilândia</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Marilândia 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Marilândia</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Marilândia</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Marilândia, 
                      ...
                      <p>
                        Para fazer ligações para Marilândia a partir de outras cidades, 
