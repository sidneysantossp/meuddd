...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Rio Novo do Sul ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Rio Novo do Sul ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Rio Novo do Sul',
      'código DDD Rio Novo do Sul ES',
      'telefone Rio Novo do Sul Espírito Santo',
      'como ligar para Rio Novo do Sul',
      'operadoras Rio Novo do Sul ES',
      'DDD Espírito Santo',
      'Rio Novo do Sul código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Rio Novo do Sul',
      'telefone Rio Novo do Sul ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Rio Novo do Sul ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Rio Novo do Sul, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Rio Novo do Sul ES`,
      description: `Guia completo do código telefônico de Rio Novo do Sul, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Rio Novo do Sul
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Rio Novo do Sul</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Rio Novo do Sul 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Rio Novo do Sul</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Rio Novo do Sul</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Rio Novo do Sul, 
                      ...
                      <p>
                        Para fazer ligações para Rio Novo do Sul a partir de outras cidades, 
