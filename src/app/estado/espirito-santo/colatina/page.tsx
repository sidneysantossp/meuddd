...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Colatina ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Colatina ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Colatina',
      'código DDD Colatina ES',
      'telefone Colatina Espírito Santo',
      'como ligar para Colatina',
      'operadoras Colatina ES',
      'DDD Espírito Santo',
      'Colatina código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Colatina',
      'telefone Colatina ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Colatina ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Colatina, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Colatina ES`,
      description: `Guia completo do código telefônico de Colatina, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Colatina</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Colatina 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Colatina</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Colatina</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Colatina, 
                      ...
                      <p>
                        Para fazer ligações para Colatina a partir de outras cidades, 
