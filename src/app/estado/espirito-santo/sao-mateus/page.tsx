...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} São Mateus ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} São Mateus ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} São Mateus',
      'código DDD São Mateus ES',
      'telefone São Mateus Espírito Santo',
      'como ligar para São Mateus',
      'operadoras São Mateus ES',
      'DDD Espírito Santo',
      'São Mateus código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para São Mateus',
      'telefone São Mateus ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} São Mateus ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de São Mateus, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} São Mateus ES`,
      description: `Guia completo do código telefônico de São Mateus, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre São Mateus</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de São Mateus 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre São Mateus</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em São Mateus</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em São Mateus, 
                      ...
                      <p>
                        Para fazer ligações para São Mateus a partir de outras cidades, 
