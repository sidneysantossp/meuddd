...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Muniz Freire ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Muniz Freire ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Muniz Freire',
      'código DDD Muniz Freire ES',
      'telefone Muniz Freire Espírito Santo',
      'como ligar para Muniz Freire',
      'operadoras Muniz Freire ES',
      'DDD Espírito Santo',
      'Muniz Freire código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Muniz Freire',
      'telefone Muniz Freire ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Muniz Freire ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Muniz Freire, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Muniz Freire ES`,
      description: `Guia completo do código telefônico de Muniz Freire, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Muniz Freire
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Muniz Freire</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Muniz Freire 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Muniz Freire</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Muniz Freire</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Muniz Freire, 
                      ...
                      <p>
                        Para fazer ligações para Muniz Freire a partir de outras cidades, 
