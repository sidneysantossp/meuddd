...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Castelo ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Castelo ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Castelo',
      'código DDD Castelo ES',
      'telefone Castelo Espírito Santo',
      'como ligar para Castelo',
      'operadoras Castelo ES',
      'DDD Espírito Santo',
      'Castelo código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Castelo',
      'telefone Castelo ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Castelo ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Castelo, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Castelo ES`,
      description: `Guia completo do código telefônico de Castelo, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Castelo</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Castelo 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Castelo</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Castelo</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Castelo, 
                      ...
                      <p>
                        Para fazer ligações para Castelo a partir de outras cidades, 
