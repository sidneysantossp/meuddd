...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Ecoporanga ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Ecoporanga ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Ecoporanga',
      'código DDD Ecoporanga ES',
      'telefone Ecoporanga Espírito Santo',
      'como ligar para Ecoporanga',
      'operadoras Ecoporanga ES',
      'DDD Espírito Santo',
      'Ecoporanga código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Ecoporanga',
      'telefone Ecoporanga ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Ecoporanga ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Ecoporanga, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Ecoporanga ES`,
      description: `Guia completo do código telefônico de Ecoporanga, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Ecoporanga</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Ecoporanga 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Ecoporanga</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Ecoporanga</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Ecoporanga, 
                      ...
                      <p>
                        Para fazer ligações para Ecoporanga a partir de outras cidades, 
