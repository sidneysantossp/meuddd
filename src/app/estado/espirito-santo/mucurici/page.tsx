...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Mucurici ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Mucurici ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Mucurici',
      'código DDD Mucurici ES',
      'telefone Mucurici Espírito Santo',
      'como ligar para Mucurici',
      'operadoras Mucurici ES',
      'DDD Espírito Santo',
      'Mucurici código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Mucurici',
      'telefone Mucurici ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Mucurici ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Mucurici, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Mucurici ES`,
      description: `Guia completo do código telefônico de Mucurici, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Mucurici</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Mucurici 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Mucurici</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Mucurici</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Mucurici, 
                      ...
                      <p>
                        Para fazer ligações para Mucurici a partir de outras cidades, 
