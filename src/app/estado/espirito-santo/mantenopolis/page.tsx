...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Mantenópolis ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Mantenópolis ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Mantenópolis',
      'código DDD Mantenópolis ES',
      'telefone Mantenópolis Espírito Santo',
      'como ligar para Mantenópolis',
      'operadoras Mantenópolis ES',
      'DDD Espírito Santo',
      'Mantenópolis código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Mantenópolis',
      'telefone Mantenópolis ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Mantenópolis ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Mantenópolis, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Mantenópolis ES`,
      description: `Guia completo do código telefônico de Mantenópolis, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Mantenópolis
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Mantenópolis</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Mantenópolis 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Mantenópolis</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Mantenópolis</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Mantenópolis, 
                      ...
                      <p>
                        Para fazer ligações para Mantenópolis a partir de outras cidades, 
