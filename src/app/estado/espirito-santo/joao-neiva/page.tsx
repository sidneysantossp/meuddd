...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} João Neiva ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} João Neiva ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} João Neiva',
      'código DDD João Neiva ES',
      'telefone João Neiva Espírito Santo',
      'como ligar para João Neiva',
      'operadoras João Neiva ES',
      'DDD Espírito Santo',
      'João Neiva código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para João Neiva',
      'telefone João Neiva ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} João Neiva ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de João Neiva, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} João Neiva ES`,
      description: `Guia completo do código telefônico de João Neiva, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre João Neiva</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de João Neiva 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre João Neiva</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em João Neiva</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em João Neiva, 
                      ...
                      <p>
                        Para fazer ligações para João Neiva a partir de outras cidades, 
