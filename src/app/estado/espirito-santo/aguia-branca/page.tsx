...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Águia Branca ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Águia Branca ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Águia Branca',
      'código DDD Águia Branca ES',
      'telefone Águia Branca Espírito Santo',
      'como ligar para Águia Branca',
      'operadoras Águia Branca ES',
      'DDD Espírito Santo',
      'Águia Branca código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Águia Branca',
      'telefone Águia Branca ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Águia Branca ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Águia Branca, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Águia Branca ES`,
      description: `Guia completo do código telefônico de Águia Branca, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Águia Branca
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Águia Branca</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Águia Branca 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Águia Branca</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Águia Branca</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Águia Branca, 
                      ...
                      <p>
                        Para fazer ligações para Águia Branca a partir de outras cidades, 
