...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Nova Venécia ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Nova Venécia ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Nova Venécia',
      'código DDD Nova Venécia ES',
      'telefone Nova Venécia Espírito Santo',
      'como ligar para Nova Venécia',
      'operadoras Nova Venécia ES',
      'DDD Espírito Santo',
      'Nova Venécia código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Nova Venécia',
      'telefone Nova Venécia ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Nova Venécia ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Nova Venécia, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Nova Venécia ES`,
      description: `Guia completo do código telefônico de Nova Venécia, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Nova Venécia
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Nova Venécia</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Nova Venécia 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Nova Venécia</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Nova Venécia</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Nova Venécia, 
                      ...
                      <p>
                        Para fazer ligações para Nova Venécia a partir de outras cidades, 
