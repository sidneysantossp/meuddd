...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Ponto Belo ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Ponto Belo ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Ponto Belo',
      'código DDD Ponto Belo ES',
      'telefone Ponto Belo Espírito Santo',
      'como ligar para Ponto Belo',
      'operadoras Ponto Belo ES',
      'DDD Espírito Santo',
      'Ponto Belo código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Ponto Belo',
      'telefone Ponto Belo ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Ponto Belo ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Ponto Belo, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Ponto Belo ES`,
      description: `Guia completo do código telefônico de Ponto Belo, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Ponto Belo</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Ponto Belo 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Ponto Belo</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Ponto Belo</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Ponto Belo, 
                      ...
                      <p>
                        Para fazer ligações para Ponto Belo a partir de outras cidades, 
