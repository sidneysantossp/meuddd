...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Pinheiros ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Pinheiros ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Pinheiros',
      'código DDD Pinheiros ES',
      'telefone Pinheiros Espírito Santo',
      'como ligar para Pinheiros',
      'operadoras Pinheiros ES',
      'DDD Espírito Santo',
      'Pinheiros código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Pinheiros',
      'telefone Pinheiros ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Pinheiros ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Pinheiros, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Pinheiros ES`,
      description: `Guia completo do código telefônico de Pinheiros, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Pinheiros</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Pinheiros 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Pinheiros</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Pinheiros</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Pinheiros, 
                      ...
                      <p>
                        Para fazer ligações para Pinheiros a partir de outras cidades, 
