...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Barra de São Francisco ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Barra de São Francisco ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Barra de São Francisco',
      'código DDD Barra de São Francisco ES',
      'telefone Barra de São Francisco Espírito Santo',
      'como ligar para Barra de São Francisco',
      'operadoras Barra de São Francisco ES',
      'DDD Espírito Santo',
      'Barra de São Francisco código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Barra de São Francisco',
      'telefone Barra de São Francisco ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Barra de São Francisco ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Barra de São Francisco, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Barra de São Francisco ES`,
      description: `Guia completo do código telefônico de Barra de São Francisco, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Barra de São Francisco
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Barra de São Francisco</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Barra de São Francisco 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Barra de São Francisco</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Barra de São Francisco</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Barra de São Francisco, 
                      ...
                      <p>
                        Para fazer ligações para Barra de São Francisco a partir de outras cidades, 
                        utilize o código 28 seguido do número do telefone. 
