...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} São Roque do Canaã ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} São Roque do Canaã ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} São Roque do Canaã',
      'código DDD São Roque do Canaã ES',
      'telefone São Roque do Canaã Espírito Santo',
      'como ligar para São Roque do Canaã',
      'operadoras São Roque do Canaã ES',
      'DDD Espírito Santo',
      'São Roque do Canaã código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para São Roque do Canaã',
      'telefone São Roque do Canaã ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} São Roque do Canaã ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de São Roque do Canaã, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} São Roque do Canaã ES`,
      description: `Guia completo do código telefônico de São Roque do Canaã, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em São Roque do Canaã
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre São Roque do Canaã</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de São Roque do Canaã 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre São Roque do Canaã</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em São Roque do Canaã</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em São Roque do Canaã, 
                      ...
                      <p>
                        Para fazer ligações para São Roque do Canaã a partir de outras cidades, 
