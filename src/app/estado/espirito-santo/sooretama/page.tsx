...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Sooretama ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Sooretama ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Sooretama',
      'código DDD Sooretama ES',
      'telefone Sooretama Espírito Santo',
      'como ligar para Sooretama',
      'operadoras Sooretama ES',
      'DDD Espírito Santo',
      'Sooretama código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Sooretama',
      'telefone Sooretama ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Sooretama ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Sooretama, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Sooretama ES`,
      description: `Guia completo do código telefônico de Sooretama, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Sooretama</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Sooretama 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Sooretama</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Sooretama</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Sooretama, 
                      ...
                      <p>
                        Para fazer ligações para Sooretama a partir de outras cidades, 
