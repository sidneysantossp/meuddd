...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Pancas ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Pancas ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Pancas',
      'código DDD Pancas ES',
      'telefone Pancas Espírito Santo',
      'como ligar para Pancas',
      'operadoras Pancas ES',
      'DDD Espírito Santo',
      'Pancas código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Pancas',
      'telefone Pancas ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Pancas ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Pancas, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Pancas ES`,
      description: `Guia completo do código telefônico de Pancas, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Pancas</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Pancas 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Pancas</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Pancas</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Pancas, 
                      ...
                      <p>
                        Para fazer ligações para Pancas a partir de outras cidades, 
