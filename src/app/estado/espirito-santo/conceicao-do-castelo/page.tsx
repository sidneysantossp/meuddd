...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Conceição do Castelo ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Conceição do Castelo ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Conceição do Castelo',
      'código DDD Conceição do Castelo ES',
      'telefone Conceição do Castelo Espírito Santo',
      'como ligar para Conceição do Castelo',
      'operadoras Conceição do Castelo ES',
      'DDD Espírito Santo',
      'Conceição do Castelo código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Conceição do Castelo',
      'telefone Conceição do Castelo ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Conceição do Castelo ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Conceição do Castelo, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Conceição do Castelo ES`,
      description: `Guia completo do código telefônico de Conceição do Castelo, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Conceição do Castelo
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Conceição do Castelo</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Conceição do Castelo 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Conceição do Castelo</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Conceição do Castelo</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Conceição do Castelo, 
                      ...
                      <p>
                        Para fazer ligações para Conceição do Castelo a partir de outras cidades, 
