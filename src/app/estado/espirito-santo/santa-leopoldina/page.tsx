...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Santa Leopoldina ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Santa Leopoldina ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Santa Leopoldina',
      'código DDD Santa Leopoldina ES',
      'telefone Santa Leopoldina Espírito Santo',
      'como ligar para Santa Leopoldina',
      'operadoras Santa Leopoldina ES',
      'DDD Espírito Santo',
      'Santa Leopoldina código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Santa Leopoldina',
      'telefone Santa Leopoldina ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Santa Leopoldina ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Santa Leopoldina, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Santa Leopoldina ES`,
      description: `Guia completo do código telefônico de Santa Leopoldina, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Santa Leopoldina
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Santa Leopoldina</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Santa Leopoldina 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Santa Leopoldina</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Santa Leopoldina</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Santa Leopoldina, 
                      ...
                      <p>
                        Para fazer ligações para Santa Leopoldina a partir de outras cidades, 
