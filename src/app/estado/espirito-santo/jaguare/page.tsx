...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Jaguaré ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Jaguaré ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Jaguaré',
      'código DDD Jaguaré ES',
      'telefone Jaguaré Espírito Santo',
      'como ligar para Jaguaré',
      'operadoras Jaguaré ES',
      'DDD Espírito Santo',
      'Jaguaré código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Jaguaré',
      'telefone Jaguaré ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Jaguaré ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Jaguaré, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Jaguaré ES`,
      description: `Guia completo do código telefônico de Jaguaré, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Jaguaré</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Jaguaré 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Jaguaré</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Jaguaré</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Jaguaré, 
                      ...
                      <p>
                        Para fazer ligações para Jaguaré a partir de outras cidades, 
