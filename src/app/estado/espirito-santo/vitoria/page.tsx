...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Vitória ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Vitória ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Vitória',
      'código DDD Vitória ES',
      'telefone Vitória Espírito Santo',
      'como ligar para Vitória',
      'operadoras Vitória ES',
      'DDD Espírito Santo',
      'Vitória código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Vitória',
      'telefone Vitória ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Vitória ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Vitória, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Vitória ES`,
      description: `Guia completo do código telefônico de Vitória, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Vitória
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              Capital do Espírito Santo e seu codigo DDD completo
            </p>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Vitória</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Vitória 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Vitória</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Vitória</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Vitória, 
                        capital do estado do Espírito Santo. 
                        Esta capital possui grande importância regional 
                        e conta com infraestrutura de telecomunicações completa.
                      </p>
                      <p>
                        Para fazer ligações para Vitória a partir de outras cidades, 
