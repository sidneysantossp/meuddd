...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Santa Maria de Jetibá ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Santa Maria de Jetibá ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Santa Maria de Jetibá',
      'código DDD Santa Maria de Jetibá ES',
      'telefone Santa Maria de Jetibá Espírito Santo',
      'como ligar para Santa Maria de Jetibá',
      'operadoras Santa Maria de Jetibá ES',
      'DDD Espírito Santo',
      'Santa Maria de Jetibá código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Santa Maria de Jetibá',
      'telefone Santa Maria de Jetibá ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Santa Maria de Jetibá ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Santa Maria de Jetibá, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Santa Maria de Jetibá ES`,
      description: `Guia completo do código telefônico de Santa Maria de Jetibá, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Santa Maria de Jetibá
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Santa Maria de Jetibá</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Santa Maria de Jetibá 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Santa Maria de Jetibá</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Santa Maria de Jetibá</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Santa Maria de Jetibá, 
                      ...
                      <p>
                        Para fazer ligações para Santa Maria de Jetibá a partir de outras cidades, 
