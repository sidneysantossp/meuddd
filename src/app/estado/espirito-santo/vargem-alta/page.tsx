...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Vargem Alta ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Vargem Alta ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Vargem Alta',
      'código DDD Vargem Alta ES',
      'telefone Vargem Alta Espírito Santo',
      'como ligar para Vargem Alta',
      'operadoras Vargem Alta ES',
      'DDD Espírito Santo',
      'Vargem Alta código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Vargem Alta',
      'telefone Vargem Alta ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Vargem Alta ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Vargem Alta, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Vargem Alta ES`,
      description: `Guia completo do código telefônico de Vargem Alta, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Vargem Alta
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Vargem Alta</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Vargem Alta 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Vargem Alta</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Vargem Alta</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Vargem Alta, 
                      ...
                      <p>
                        Para fazer ligações para Vargem Alta a partir de outras cidades, 
