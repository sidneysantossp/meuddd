...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Viana ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Viana ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Viana',
      'código DDD Viana ES',
      'telefone Viana Espírito Santo',
      'como ligar para Viana',
      'operadoras Viana ES',
      'DDD Espírito Santo',
      'Viana código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Viana',
      'telefone Viana ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Viana ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Viana, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Viana ES`,
      description: `Guia completo do código telefônico de Viana, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Viana</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Viana 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Viana</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Viana</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Viana, 
                      ...
                      <p>
                        Para fazer ligações para Viana a partir de outras cidades, 
