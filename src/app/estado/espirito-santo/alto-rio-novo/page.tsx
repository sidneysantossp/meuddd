...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Alto Rio Novo ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Alto Rio Novo ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Alto Rio Novo',
      'código DDD Alto Rio Novo ES',
      'telefone Alto Rio Novo Espírito Santo',
      'como ligar para Alto Rio Novo',
      'operadoras Alto Rio Novo ES',
      'DDD Espírito Santo',
      'Alto Rio Novo código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Alto Rio Novo',
      'telefone Alto Rio Novo ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Alto Rio Novo ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Alto Rio Novo, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Alto Rio Novo ES`,
      description: `Guia completo do código telefônico de Alto Rio Novo, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Alto Rio Novo
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Alto Rio Novo</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Alto Rio Novo 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Alto Rio Novo</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Alto Rio Novo</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Alto Rio Novo, 
                      ...
                      <p>
                        Para fazer ligações para Alto Rio Novo a partir de outras cidades, 
