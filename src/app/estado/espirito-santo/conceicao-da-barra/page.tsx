...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Conceição da Barra ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Conceição da Barra ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Conceição da Barra',
      'código DDD Conceição da Barra ES',
      'telefone Conceição da Barra Espírito Santo',
      'como ligar para Conceição da Barra',
      'operadoras Conceição da Barra ES',
      'DDD Espírito Santo',
      'Conceição da Barra código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Conceição da Barra',
      'telefone Conceição da Barra ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Conceição da Barra ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Conceição da Barra, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Conceição da Barra ES`,
      description: `Guia completo do código telefônico de Conceição da Barra, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Conceição da Barra
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Conceição da Barra</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Conceição da Barra 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Conceição da Barra</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Conceição da Barra</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Conceição da Barra, 
                      ...
                      <p>
                        Para fazer ligações para Conceição da Barra a partir de outras cidades, 
