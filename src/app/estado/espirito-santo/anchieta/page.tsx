...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Anchieta ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Anchieta ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Anchieta',
      'código DDD Anchieta ES',
      'telefone Anchieta Espírito Santo',
      'como ligar para Anchieta',
      'operadoras Anchieta ES',
      'DDD Espírito Santo',
      'Anchieta código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Anchieta',
      'telefone Anchieta ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Anchieta ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Anchieta, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Anchieta ES`,
      description: `Guia completo do código telefônico de Anchieta, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Anchieta</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Anchieta 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Anchieta</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Anchieta</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Anchieta, 
                      ...
                      <p>
                        Para fazer ligações para Anchieta a partir de outras cidades, 
