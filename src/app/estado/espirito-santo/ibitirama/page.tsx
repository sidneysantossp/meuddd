...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Ibitirama ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Ibitirama ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Ibitirama',
      'código DDD Ibitirama ES',
      'telefone Ibitirama Espírito Santo',
      'como ligar para Ibitirama',
      'operadoras Ibitirama ES',
      'DDD Espírito Santo',
      'Ibitirama código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Ibitirama',
      'telefone Ibitirama ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Ibitirama ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Ibitirama, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Ibitirama ES`,
      description: `Guia completo do código telefônico de Ibitirama, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Ibitirama</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Ibitirama 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Ibitirama</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Ibitirama</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Ibitirama, 
                      ...
                      <p>
                        Para fazer ligações para Ibitirama a partir de outras cidades, 
