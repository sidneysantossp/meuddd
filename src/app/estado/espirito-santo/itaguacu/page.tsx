...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Itaguaçu ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Itaguaçu ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Itaguaçu',
      'código DDD Itaguaçu ES',
      'telefone Itaguaçu Espírito Santo',
      'como ligar para Itaguaçu',
      'operadoras Itaguaçu ES',
      'DDD Espírito Santo',
      'Itaguaçu código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Itaguaçu',
      'telefone Itaguaçu ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Itaguaçu ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Itaguaçu, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Itaguaçu ES`,
      description: `Guia completo do código telefônico de Itaguaçu, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Itaguaçu</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Itaguaçu 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Itaguaçu</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Itaguaçu</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Itaguaçu, 
                      ...
                      <p>
                        Para fazer ligações para Itaguaçu a partir de outras cidades, 
