...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Apiacá ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Apiacá ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Apiacá',
      'código DDD Apiacá ES',
      'telefone Apiacá Espírito Santo',
      'como ligar para Apiacá',
      'operadoras Apiacá ES',
      'DDD Espírito Santo',
      'Apiacá código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Apiacá',
      'telefone Apiacá ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Apiacá ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Apiacá, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Apiacá ES`,
      description: `Guia completo do código telefônico de Apiacá, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Apiacá</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Apiacá 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Apiacá</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Apiacá</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Apiacá, 
                      ...
                      <p>
                        Para fazer ligações para Apiacá a partir de outras cidades, 
