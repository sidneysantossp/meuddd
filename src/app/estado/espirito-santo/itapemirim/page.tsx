...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Itapemirim ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Itapemirim ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Itapemirim',
      'código DDD Itapemirim ES',
      'telefone Itapemirim Espírito Santo',
      'como ligar para Itapemirim',
      'operadoras Itapemirim ES',
      'DDD Espírito Santo',
      'Itapemirim código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Itapemirim',
      'telefone Itapemirim ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Itapemirim ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Itapemirim, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Itapemirim ES`,
      description: `Guia completo do código telefônico de Itapemirim, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Itapemirim</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Itapemirim 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Itapemirim</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Itapemirim</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Itapemirim, 
                      ...
                      <p>
                        Para fazer ligações para Itapemirim a partir de outras cidades, 
