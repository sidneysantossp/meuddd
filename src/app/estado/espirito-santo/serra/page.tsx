...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Serra ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Serra ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Serra',
      'código DDD Serra ES',
      'telefone Serra Espírito Santo',
      'como ligar para Serra',
      'operadoras Serra ES',
      'DDD Espírito Santo',
      'Serra código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Serra',
      'telefone Serra ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Serra ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Serra, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Serra ES`,
      description: `Guia completo do código telefônico de Serra, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Serra</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Serra 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Serra</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Serra</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Serra, 
                      ...
                      <p>
                        Para fazer ligações para Serra a partir de outras cidades, 
