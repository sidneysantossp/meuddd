...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Montanha ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Montanha ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Montanha',
      'código DDD Montanha ES',
      'telefone Montanha Espírito Santo',
      'como ligar para Montanha',
      'operadoras Montanha ES',
      'DDD Espírito Santo',
      'Montanha código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Montanha',
      'telefone Montanha ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Montanha ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Montanha, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Montanha ES`,
      description: `Guia completo do código telefônico de Montanha, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Montanha</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Montanha 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Montanha</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Montanha</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Montanha, 
                      ...
                      <p>
                        Para fazer ligações para Montanha a partir de outras cidades, 
