...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} São Gabriel da Palha ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} São Gabriel da Palha ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} São Gabriel da Palha',
      'código DDD São Gabriel da Palha ES',
      'telefone São Gabriel da Palha Espírito Santo',
      'como ligar para São Gabriel da Palha',
      'operadoras São Gabriel da Palha ES',
      'DDD Espírito Santo',
      'São Gabriel da Palha código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para São Gabriel da Palha',
      'telefone São Gabriel da Palha ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} São Gabriel da Palha ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de São Gabriel da Palha, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} São Gabriel da Palha ES`,
      description: `Guia completo do código telefônico de São Gabriel da Palha, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em São Gabriel da Palha
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre São Gabriel da Palha</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de São Gabriel da Palha 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre São Gabriel da Palha</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em São Gabriel da Palha</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em São Gabriel da Palha, 
                      ...
                      <p>
                        Para fazer ligações para São Gabriel da Palha a partir de outras cidades, 
