...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Vila Valério ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Vila Valério ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Vila Valério',
      'código DDD Vila Valério ES',
      'telefone Vila Valério Espírito Santo',
      'como ligar para Vila Valério',
      'operadoras Vila Valério ES',
      'DDD Espírito Santo',
      'Vila Valério código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Vila Valério',
      'telefone Vila Valério ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Vila Valério ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Vila Valério, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Vila Valério ES`,
      description: `Guia completo do código telefônico de Vila Valério, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Vila Valério
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Vila Valério</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Vila Valério 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Vila Valério</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Vila Valério</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Vila Valério, 
                      ...
                      <p>
                        Para fazer ligações para Vila Valério a partir de outras cidades, 
