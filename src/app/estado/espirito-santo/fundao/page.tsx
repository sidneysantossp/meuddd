...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Fundão ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Fundão ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Fundão',
      'código DDD Fundão ES',
      'telefone Fundão Espírito Santo',
      'como ligar para Fundão',
      'operadoras Fundão ES',
      'DDD Espírito Santo',
      'Fundão código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Fundão',
      'telefone Fundão ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Fundão ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Fundão, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Fundão ES`,
      description: `Guia completo do código telefônico de Fundão, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Fundão</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Fundão 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Fundão</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Fundão</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Fundão, 
                      ...
                      <p>
                        Para fazer ligações para Fundão a partir de outras cidades, 
