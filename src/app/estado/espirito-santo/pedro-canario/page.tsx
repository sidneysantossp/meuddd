...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Pedro Canário ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Pedro Canário ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Pedro Canário',
      'código DDD Pedro Canário ES',
      'telefone Pedro Canário Espírito Santo',
      'como ligar para Pedro Canário',
      'operadoras Pedro Canário ES',
      'DDD Espírito Santo',
      'Pedro Canário código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Pedro Canário',
      'telefone Pedro Canário ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Pedro Canário ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Pedro Canário, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Pedro Canário ES`,
      description: `Guia completo do código telefônico de Pedro Canário, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">
              DDD {mainDddCode} em Pedro Canário
            </h1>
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Pedro Canário</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Pedro Canário 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Pedro Canário</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Pedro Canário</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Pedro Canário, 
                      ...
                      <p>
                        Para fazer ligações para Pedro Canário a partir de outras cidades, 
