...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Ibiraçu ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Ibiraçu ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Ibiraçu',
      'código DDD Ibiraçu ES',
      'telefone Ibiraçu Espírito Santo',
      'como ligar para Ibiraçu',
      'operadoras Ibiraçu ES',
      'DDD Espírito Santo',
      'Ibiraçu código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Ibiraçu',
      'telefone Ibiraçu ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Ibiraçu ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Ibiraçu, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Ibiraçu ES`,
      description: `Guia completo do código telefônico de Ibiraçu, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Ibiraçu</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Ibiraçu 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Ibiraçu</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 28 em Ibiraçu</h2>
                      <p>
                        O código DDD 28 é utilizado para ligações telefônicas em Ibiraçu, 
                      ...
                      <p>
                        Para fazer ligações para Ibiraçu a partir de outras cidades, 
