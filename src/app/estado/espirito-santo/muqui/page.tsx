...
export async function generateMetadata({ 
  ...
  return {
    title: `DDD ${mainDddCode} Muqui ES | Código Telefônico Completo 2024`,
    description: `DDD ${mainDddCode} Muqui ES: guia completo do código telefônico. Informações detalhadas sobre como ligar, operadoras, áreas de cobertura e dados demográficos. Atualizado 2024.`,
    keywords: [
      'DDD ${mainDddCode} Muqui',
      'código DDD Muqui ES',
      'telefone Muqui Espírito Santo',
      'como ligar para Muqui',
      'operadoras Muqui ES',
      'DDD Espírito Santo',
      'Muqui código telefônico',
      'DDD ${mainDddCode} Espírito Santo',
      'ligações para Muqui',
      'telefone Muqui ES'
    ],
    openGraph: {
      title: `DDD ${mainDddCode} Muqui ES | Guia Completo`,
      description: `Informações completas sobre o DDD ${mainDddCode} de Muqui, Espírito Santo. Como fazer ligações, operadoras disponíveis e dados da cidade.`,
    ...
    twitter: {
      ...
      title: `DDD ${mainDddCode} Muqui ES`,
      description: `Guia completo do código telefônico de Muqui, ES. Informações atualizadas sobre DDD ${mainDddCode}.`,
    },
  }
}
            ...
            <Tabs defaultValue="sobre" className="w-full">
              <TabsList className="grid w-full grid-cols-7">
                ...
                <TabsTrigger value="sobre" className="flex items-center gap-1">
                  ...
                  <span className="hidden sm:inline">Sobre Muqui</span>
                </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        O código DDD {mainDddCode} é utilizado para ligações telefônicas na cidade de Muqui 
              ...
              <TabsContent value="sobre" className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Sobre Muqui</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose max-w-none">
                      <h2>DDD 27 em Muqui</h2>
                      <p>
                        O código DDD 27 é utilizado para ligações telefônicas em Muqui, 
                      ...
                      <p>
                        Para fazer ligações para Muqui a partir de outras cidades, 
