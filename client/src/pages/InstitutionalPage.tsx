  ...
  return (
    <div className="mt-12 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
      <section className="rounded-3xl bg-[#143d36] p-7 text-[#faf3e5] shadow-[0_14px_36px_rgba(20,61,54,0.14)] sm:p-8" aria-labelledby="brand-kit-title">
        ...
        <a href="/assets/kit-marca-meu-ddd.zip" download className="pressable mt-6 inline-flex items-center gap-2 rounded-full bg-[#f06a4d] px-5 py-3 text-sm font-bold text-[#fffaf1] hover:bg-[#ff7a5f]">Baixar kit de marca <Download size={16} /></a>
      </section>
