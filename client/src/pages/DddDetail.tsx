...
export default function DddDetail() {
  ...
  return <main className="page-shell min-h-screen bg-[#faf3e5] text-[#143d36]">
    <header className="border-b border-[#d9d1bf] bg-[#faf3e5]/90 backdrop-blur"><div className="container flex min-h-[78px] items-center justify-between gap-4"><Link href="/#buscar" className="inline-flex items-center gap-2 text-sm font-bold text-[#143d36]"><ArrowLeft size={17} /> DDD Brasil</Link><ShareActions compact path={`/ddd/${code}`} title={`DDD ${data.code}: cidades e estados abrangidos`} /></div></header>
