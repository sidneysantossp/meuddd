  ...
  return (
    <div id="topo" className="page-shell min-h-screen">
      ...
      <main>
        ...
        <section id="sobre" className="bg-[#143d36] py-20 lg:py-24"><div className="container grid gap-10 lg:grid-cols-[1fr_0.7fr] lg:py-0"><div><div className="mb-4 text-[10px] font-bold uppercase tracking-[0.24em] text-[#f06a4d]">Um atlas para o dia a dia</div><h2 className="font-display max-w-[620px] text-5xl leading-[0.95] tracking-[-0.06em] text-[#faf3e5] sm:text-6xl">Menos dúvida na hora de <em className="font-normal">conectar.</em></h2></div><div className="border-l border-[#35604f] pl-6 text-sm leading-7 text-[#b8cec4]"><p>O Meu DDD organiza os códigos de área do país em uma busca rápida, com ligação direta para cada DDD e leitura visual por estado.</p><div className="mt-8 flex items-center gap-3 text-xs font-bold text-[#faf3e5]"><span className="grid size-9 place-items-center rounded-full bg-[#f06a4d]"><Phone size={15} /></span> Informação clara, de ponta a ponta.</div></div></div></section>
      </main>
