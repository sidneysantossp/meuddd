...
const brasiliaHeritage: LocalSource = {
  label:
    "Património Cultural — Secretaria de Cultura e Economia Criativa do DF",
...
const localityContent: Record<string, LocalityContent> = {
    ...
    heritage: [
      {
        ...
        description:
          "A capela é citada pela Prefeitura como parte da origem do aldeamento de Barueri.",
    ...
    parks: [
      {
        ...
        description:
          "Espaço municipal de lazer com áreas de caminhada, atividades e instalações desportivas, conforme a Prefeitura.",
      ...
      },
      {
        ...
        description:
          "Parque municipal com área de lazer e recuperação ambiental, trilhas, lagos e equipamentos de uso público.",
      ...
      },
      {
        ...
        description:
          "Parque municipal no Parque Imperial com pista de caminhada, playground e áreas para atividades.",
  ...
  "mg:belo-horizonte": {
    ...
    heritage: [
      {
        ...
        description:
          "A Belotur reúne museus, centros culturais e percursos de cidade; abra o portal oficial para informação actualizada e, em seguida, planeie a visita no mapa.",
    ...
    parks: [
      {
        ...
        description:
          "O portal oficial possui uma secção própria de parques e praças. Verifique horários e regras no canal indicado antes da visita.",
    ...
    municipalServices: [
      {
        title: "Informações úteis de saúde em Belo Horizonte",
        href: "https://portalbelohorizonte.com.br/informacoes-uteis/pronto-socorro-hospitais",
        source: beloHorizonteTourism,
      },
      {
        title: "Segurança e serviços públicos em Belo Horizonte",
        href: "https://portalbelohorizonte.com.br/informacoes-uteis/policia-militar-do-estado-de-minas-gerais",
        source: beloHorizonteTourism,
      },
      {
        title: "Bares e restaurantes: descoberta no portal oficial",
        href: "https://portalbelohorizonte.com.br/o-que-fazer/comer-e-beber",
        source: beloHorizonteTourism,
      },
    ],
  },
  "pr:curitiba": {
    ...
    heritage: [
      {
        ...
        description:
          "A página institucional apresenta equipamentos culturais e percursos urbanos. Utilize o mapa para abrir a pesquisa da região desejada.",
    ...
    parks: [
      {
        title: "Parque Tanguá",
        description:
          "O Parque Tanguá é referenciado pela Prefeitura entre os parques da cidade. Verifique condições de acesso no portal municipal.",
        href: mapSearchUrl("Parque Tanguá Curitiba PR"),
        source: curitibaCity,
      },
      {
        title: "Parque Tingui",
        description:
          "O Parque Tingui é citado pela Prefeitura no contexto de parques urbanos. Abra a pesquisa no mapa para planear o trajeto.",
        href: mapSearchUrl("Parque Tingui Curitiba PR"),
        source: curitibaCity,
      },
    ],
    mobility: {
    ...
    municipalServices: [
      {
        title: "Portal de serviços de Curitiba",
        href: "https://www.curitiba.pr.gov.br/",
        source: curitibaCity,
      },
      {
        title: "Bares e restaurantes em Curitiba: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Curitiba PR"),
        source: curitibaCity,
      },
    ],
  },
  "rs:porto-alegre": {
    ...
    heritage: [
      {
        ...
        description:
          "O portal oficial possui uma secção dedicada à cultura e a locais para visitar. Abra o mapa para localizar museus e pontos históricos próximos.",
    ...
    parks: [
      {
        ...
        description:
          "O Parque Moinhos de Vento integra os locais apresentados pelo portal oficial de turismo. Confirme a programação e os serviços antes da visita.",
    ...
    municipalServices: [
      {
        title: "Informações úteis para visitantes de Porto Alegre",
        href: "https://destinopoa.com.br/",
        source: portoAlegreTourism,
      },
      {
        title: "Gastronomia e bares: descoberta no portal oficial",
        href: "https://destinopoa.com.br/secao/poa-da-gastronomia/",
        source: portoAlegreTourism,
      },
    ],
  },
    ...
    heritage: [
      {
        ...
        description:
          "O equipamento é apresentado pela Secult entre as referências culturais da cidade. Consulte a fonte oficial para informação de visitação.",
        href: mapSearchUrl("Casa do Carnaval da Bahia Salvador BA"),
        source: salvadorCulture,
      },
      {
        title: "Espaços Carybé e Pierre Verger",
        description:
          "A Secult apresenta estes espaços no seu portal de património e cultura. Abra o mapa para localizar o conjunto cultural.",
        href: mapSearchUrl("Espaço Carybé e Pierre Verger Salvador BA"),
        source: salvadorCulture,
      },
    ],
    parks: [
      {
        title: "Parques e áreas ao ar livre em Salvador",
        description:
          "Use a pesquisa cartográfica para explorar parques e praças; confirme regras, acesso e programação junto aos canais públicos responsáveis.",
        href: mapSearchUrl("parques e praças Salvador BA"),
        source: salvadorCulture,
      },
    ],
    mobility: {
      body: "A Semob é o canal municipal de referência para actualizações de mobilidade. Consulte a fonte oficial antes de viajar, pois linhas, horários e intervenções podem mudar.",
      href: salvadorMobility.url,
      source: salvadorMobility,
    },
    municipalServices: [
      {
        title: "Agenda e cultura de Salvador",
        href: salvadorCulture.url,
        source: salvadorCulture,
      },
      {
        title: "Bares e restaurantes em Salvador: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Salvador BA"),
        source: salvadorCulture,
      },
    ],
  },
  "pe:recife": {
    ...
    heritage: [
      {
        title: "Cultura e roteiros do Recife",
        description:
          "A secretaria municipal promove roteiros turísticos e a valorização do património local. Abra a pesquisa no mapa para planear uma visita no território escolhido.",
        href: mapSearchUrl("centro histórico e museus Recife PE"),
        source: recifeTourism,
      },
    ],
    parks: [
      {
        title: "Parques e lazer no Recife",
        description:
          "O município mantém políticas e acções de lazer em espaços públicos. Confirme as informações específicas do parque no canal público antes de sair.",
        href: mapSearchUrl("parques e praças Recife PE"),
        source: recifeTourism,
      },
    ],
    mobility: {
      body: "O Grande Recife disponibiliza notícias e serviços do transporte metropolitano. Consulte o portal para rotas, tarifas, alterações operacionais e planeamento da viagem.",
      href: recifeMobility.url,
      source: recifeMobility,
    },
    municipalServices: [
      {
        title: "Turismo, lazer e contacto institucional do Recife",
        href: recifeTourism.url,
        source: recifeTourism,
      },
      {
        title: "Gastronomia do Recife: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Recife PE"),
        source: recifeTourism,
      },
    ],
  },
  "ce:fortaleza": {
    history: {
      body: "O Canal Turismo da Prefeitura de Fortaleza reúne referências de arte, cultura, lazer e património. Consulte o portal institucional para aprofundar a história dos equipamentos e confirmar visitações.",
      source: fortalezaTourism,
    },
    heritage: [
      {
        title: "Theatro José de Alencar",
        description:
          "Segundo o Canal Turismo municipal, o teatro foi inaugurado em 1910, recebe programação cultural e é reconhecido como Património Histórico Nacional pelo Iphan.",
        href: mapSearchUrl("Theatro José de Alencar Fortaleza CE"),
        source: fortalezaTourism,
      },
    ],
    parks: [
      {
        ...
        description:
          "O portal turístico municipal apresenta o parque como área urbana de natureza, trilhas e actividades ao ar livre. Consulte a fonte para condições e programação.",
        href: mapSearchUrl("Parque Estadual do Cocó Fortaleza CE"),
        source: fortalezaTourism,
      },
      {
        title: "Parque Rachel de Queiroz",
        description:
          "O Canal Turismo apresenta o parque como espaço de áreas verdes, ciclovias, pistas e manifestações culturais. Verifique a informação oficial antes de visitar.",
        href: mapSearchUrl("Parque Rachel de Queiroz Fortaleza CE"),
        source: fortalezaTourism,
      },
    ],
    mobility: {
      body: "A Prefeitura publicou um projecto-piloto de transporte de curta distância em bairros específicos da cidade. Como a iniciativa é experimental e limitada, consulte a fonte original para elegibilidade e condições vigentes.",
      href: fortalezaMobility.url,
      source: fortalezaMobility,
    },
    municipalServices: [
      {
        title: "Pontos turísticos e agenda oficial de Fortaleza",
        href: fortalezaTourism.url,
        source: fortalezaTourism,
      },
      {
        title: "Gastronomia em Fortaleza: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Fortaleza CE"),
        source: fortalezaTourism,
      },
    ],
  },
  "sp:sao-paulo": {
    ...
    heritage: [
      {
        ...
        description:
          "Os canais oficiais de cultura e turismo reúnem percursos de cidade, museus e espaços culturais. Abra o mapa para localizar equipamentos próximos e confirme horários no canal responsável.",
    ...
    parks: [
      {
        ...
        description:
          "O portal turístico oficial organiza referências para explorar a cidade. Consulte o canal público e as regras do parque escolhido antes da visita.",
    ...
    municipalServices: [
      {
        title: "Serviços e telefones úteis de São Paulo",
        href: "https://sp156.prefeitura.sp.gov.br/portal/servicos",
        source: saoPauloTourism,
      },
      {
        title: "Roteiros e agenda oficial de São Paulo",
        href: saoPauloTourism.url,
        source: saoPauloTourism,
      },
      {
        title: "Bares e restaurantes em São Paulo: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes São Paulo SP"),
        source: saoPauloTourism,
      },
    ],
  },
  "rj:rio-de-janeiro": {
    ...
    heritage: [
      {
        ...
        description:
          "A Secretaria Municipal de Turismo apresenta circuitos de património em zonas como Centro, Lapa, Glória e Zona Sul. Aceda à fonte para mapas, contexto e actualizações.",
        href: rioMemory.url,
        source: rioMemory,
      },
    ],
    parks: [
      {
        ...
        description:
          "A Riotur reúne informações oficiais para explorar atrações ao ar livre. Confirme condições de acesso e programação antes de sair.",
    ...
    municipalServices: [
      {
        title: "Informações turísticas oficiais do Rio de Janeiro",
        href: rioTourism.url,
        source: rioTourism,
      },
      {
        title: "Serviços e mobilidade do Rio de Janeiro",
        href: rioMobility.url,
        source: rioMobility,
      },
      {
        title: "Bares e restaurantes no Rio: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Rio de Janeiro RJ"),
        source: rioTourism,
      },
    ],
  },
  "df:brasilia": {
    ...
    heritage: [
      {
        ...
        description:
          "A política cultural do DF apresenta referências materiais e imateriais do território, incluindo a preservação urbanística de Brasília. Aceda ao canal institucional para contexto e normas de visitação.",
    ...
    parks: [
      {
        ...
        description:
          "O portal de turismo do Distrito Federal reúne informação para visitantes. Planeie percursos e confirme serviços, acesso e programação no canal público responsável.",
    ...
    municipalServices: [
      {
        title: "Informações turísticas e roteiros oficiais de Brasília",
        href: brasiliaTourism.url,
        source: brasiliaTourism,
      },
      {
        title: "Mobilidade e serviços de transporte do Distrito Federal",
        href: brasiliaMobility.url,
        source: brasiliaMobility,
      },
      {
        title: "Bares e restaurantes em Brasília: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Brasília DF"),
        source: brasiliaTourism,
      },
    ],
  },
  "am:manaus": {
    ...
    heritage: [
      {
        ...
        description:
          "Utilize o mapa para localizar museus, mercados e referências históricas da cidade. Para informações de visitação e programação, confirme sempre o canal público responsável.",
    ...
    parks: [
      {
        ...
        description:
          "A Prefeitura descreve o equipamento como complexo turístico e cultural com jardins e infraestrutura de uso público. Consulte a fonte institucional para o estado das obras, abertura e serviços disponíveis.",
    ...
    municipalServices: [
      {
        title: "Serviços e canais da Prefeitura de Manaus",
        href: "https://www.manaus.am.gov.br/",
        source: manausTourism,
      },
      {
        title: "Bares e restaurantes em Manaus: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Manaus AM"),
        source: manausTourism,
      },
    ],
  },
  "pa:belem": {
    ...
    heritage: [
      {
        ...
        description:
          "A secretaria mantém recursos de orientação turística para visitantes. Abra o mapa para localizar referências culturais e confirme informações práticas nos canais públicos.",
    ...
    parks: [
      {
        ...
        description:
          "Explore espaços verdes e áreas públicas no mapa; confirme acesso, programação e regras junto às fontes oficiais antes da visita.",
    ...
    municipalServices: [
      {
        title: "Turismo e Centro de Informações ao Turista de Belém",
        href: belemTourism.url,
        source: belemTourism,
      },
      {
        title: "Bares e restaurantes em Belém: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Belém PA"),
        source: belemTourism,
      },
    ],
  },
  "go:goiania": {
    ...
    heritage: [
      {
        ...
        description:
          "A GoiâniaTur publica um roteiro dedicado a cultura e lazer com enfoque Art Déco. Abra a fonte oficial para o percurso e confirme os pontos de interesse antes de sair.",
    ...
    parks: [
      {
        ...
        description:
          "O portal municipal apresenta roteiros entre parques, incluindo percursos que passam pelo Lago das Rosas e Jardim Botânico. Consulte a fonte para detalhes e condições de visitação.",
    ...
    municipalServices: [
      {
        title: "Centros de Atendimento ao Turista e telefones úteis de Goiânia",
        href: "https://www.goiania.go.gov.br/goianiatur/turismo/cats/",
        source: goianiaTourism,
      },
      {
        title: "Bares e restaurantes em Goiânia: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Goiânia GO"),
        source: goianiaTourism,
      },
    ],
  },
  "sc:florianopolis": {
    ...
    heritage: [
      {
        ...
        description:
          "O projecto municipal Ponte Viva relaciona mobilidade, turismo e património. Abra a fonte para conhecer o enquadramento institucional e confirme as condições de visitação antes de sair.",
    ...
    parks: [
      {
        title: "Parque da Luz",
        description:
          "A Prefeitura mantém informações públicas sobre intervenções e uso dos espaços urbanos. Consulte o canal municipal para atualizações e abra o mapa para planear o acesso.",
    ...
    municipalServices: [
      {
        title: "Serviços e atendimento da Prefeitura de Florianópolis",
        href: florianopolisMunicipal.url,
        source: florianopolisMunicipal,
      },
      {
        title: "Bares e restaurantes em Florianópolis: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Florianópolis SC"),
        source: florianopolisMunicipal,
      },
    ],
  },
  "es:vitoria": {
    ...
    heritage: [
      {
        ...
        description:
          "O guia turístico municipal reúne referências para o centro histórico, património cultural, museus e monumentos. Consulte a fonte para contexto e condições práticas antes da visita.",
    ...
    parks: [
      {
        ...
        description:
          "O portal turístico da cidade mantém secções dedicadas a parques e às trilhas da Gruta da Onça. Confirme acesso, programação e recomendações no canal municipal antes de visitar.",
    ...
    municipalServices: [
      {
        title: "Informações turísticas e serviços de Vitória",
        href: "https://www.vitoria.es.gov.br/turista/informacoes-turisticas",
        source: vitoriaTourism,
      },
      {
        title: "Bares e restaurantes em Vitória: guia municipal",
        href: "https://www.vitoria.es.gov.br/turista/bares-e-restaurantes",
        source: vitoriaTourism,
      },
    ],
  },
  "ms:campo-grande": {
    ...
    heritage: [
      {
        ...
        description:
          "O canal municipal de turismo reúne referências para eventos, cultura e serviços ao visitante. Abra a fonte institucional para detalhes e use o mapa para localizar os equipamentos de interesse.",
    ...
    parks: [
      {
        ...
        description:
          "A Prefeitura publica atualizações sobre o Horto Florestal e as suas atividades públicas. Verifique o canal municipal antes da visita, pois acesso e programação podem mudar.",
    ...
    municipalServices: [
      {
        title: "Turismo de negócios e eventos em Campo Grande",
        href: campoGrandeTourism.url,
        source: campoGrandeTourism,
      },
      {
        title: "Bares e restaurantes em Campo Grande: pesquisa no mapa",
        href: mapSearchUrl("bares e restaurantes Campo Grande MS"),
        source: campoGrandeTourism,
      },
    ],
  },
