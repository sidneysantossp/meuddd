...
- [ ] Bug (2026-08-13, tabs invisíveis): o utilizador não localiza o conteúdo editorial da cidade na página municipal (ex.: Araçariguama/SP mostra só cartões com links do Google Maps, sem tabs Pontos Turísticos/Bares/Transporte/Clima). Diagnosticar porque o render cai sempre no fallback LocalityContext mesmo para municípios do SP piloto que têm tabs integradas; corrigir a lógica de deteção das tabs no SSR (prefetch) e no cliente (initialData/localityTabs.byMunicipality) e validar com /cidade/sp/aracariguama e /cidade/ac/cruzeiro-do-sul.
